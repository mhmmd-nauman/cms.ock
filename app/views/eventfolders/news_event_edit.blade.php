                        ...
                        <div class="modal-body">
                          <div class="form">
                              ...
                              <div class="form-actions">
                                  <div class="col-md-offset-5 col-md-8"> <input type="submit" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                          ...
                          <div class="form">
                            <form class="form-horizontal" >
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label">Event Title <span class='require'>*</span></label>
                                <div class="col-md-9">
                                  <textarea name="inputContent" rows="2" class="form-control" id="inputContent" placeholder="Event Title" value="{{ $value->status }}" ></textarea>
                                </div>
                              </div>
                              <div class="form-group">
                                ...
                                <div class="col-md-5">
                                  <div class="input-group">
                                    <input type="text" class="datepicker-default form-control" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="{{ $value->date }}"/>
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                              </div>
